...
def topology(run_number, stream_name, nr_of_clients):
    ...
    uav_list.append(net.addStation('sta1', mac='33:33:33:00:00:01', ip='10.0.0.1/24', min_x=40, max_x=66, min_y=20, max_y=66, wlans=1))
    uav_list.append(net.addStation('sta2', mac='33:33:33:00:00:02', ip='10.0.0.2/24', min_x=67, max_x=133, min_y=20, max_y=66, wlans=1))
    uav_list.append(net.addStation('sta3', mac='33:33:33:00:00:03', ip='10.0.0.3/24', min_x=134, max_x=180, min_y=20, max_y=66, wlans=1))
    uav_list.append(net.addStation('sta4', mac='33:33:33:00:00:04', ip='10.0.0.4/24', min_x=40, max_x=66, min_y=67, max_y=133, wlans=1))
    uav_list.append(net.addStation('sta5', mac='33:33:33:00:00:05', ip='10.0.0.5/24', min_x=67, max_x=133, min_y=67, max_y=133, wlans=1))
    uav_list.append(net.addStation('sta6', mac='33:33:33:00:00:06', ip='10.0.0.6/24', min_x=134, max_x=180, min_y=67, max_y=133, wlans=1))
    uav_list.append(net.addStation('sta7', mac='33:33:33:00:00:07', ip='10.0.0.7/24', min_x=40, max_x=66, min_y=134, max_y=160, wlans=1))
    uav_list.append(net.addStation('sta8', mac='33:33:33:00:00:08', ip='10.0.0.8/24', min_x=67, max_x=133, min_y=134, max_y=160, wlans=1))
    uav_list.append(net.addStation('sta9', mac='33:33:33:00:00:09', ip='10.0.0.9/24', min_x=134, max_x=180, min_y=134, max_y=160, wlans=1))
    ...
    #                  min_x=40, max_x=160, min_y=40, max_y=160, min_v=1, max_v=2)
